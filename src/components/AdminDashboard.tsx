...
import { Users, MessageSquare, AlertCircle, CheckCircle, TrendingUp, Clock, Phone, Mail, Globe } from 'lucide-react';
        ...
        <div className="p-6">
          ...
          {recentComplaints.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className={isDarkMode ? 'text-gray-400' : 'text-gray-500'}>No messages or complaints yet</p>
            </div>
          )}
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className={`p-4 rounded-lg border ${isDarkMode ? 'border-gray-600 hover:border-green-500' : 'border-gray-200 hover:border-green-300'} transition-colors cursor-pointer`}>
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className={`font-medium ${isDarkMode ? 'text-gray-200' : 'text-gray-800'}`}>Bulk Reply</h3>
